...
if __name__ == '__main__':
    ...
    # /Users/haopengsong/553/output.txt
    ...
    sorted(topUserResult, key = lambda i : i[1], reverse = True)
    sorted(topBusinessWithReview, key = lambda i : i[1], reverse = True)

    result = {}
    result['n_review_useful'] = sumUsefulReview
    result['n_review_5_star'] = sumStartReview
    result['n_characters'] = longestReviewLen
    result['n_user'] = numUserReviews
    result['top20_user'] = topUserResult
    result['n_business'] = numBusinessReviewed
    result['top20_business'] = topBusinessWithReview
